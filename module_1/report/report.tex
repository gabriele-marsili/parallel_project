...
\midrule
Baseline (no-vec) & 918 & 1.00$\times$ & 11.0 \\
Auto-vectorized   & 1310 & 1.43$\times$ & 15.7 \\
AVX2 intrinsics   & 1200 & 1.31$\times$ & 14.4 \\
\midrule
CUDA kernel-only  & 67\,320 & 73.4$\times$ & 808 \\
CUDA end-to-end   & 1\,031 & 1.12$\times$ & 12.4 \\
\bottomrule
\end{tabular}
...
The attainable performance ceiling at $I\!=\!0.33$ is $I \times B_\text{peak} = 5.47$ Gops/s. The auto-vectorized version achieves 5.24 Gops/s = \textbf{96\% of the bandwidth ceiling}. Figure~\ref{fig:roofline} confirms all three implementations lie on the bandwidth ramp.
