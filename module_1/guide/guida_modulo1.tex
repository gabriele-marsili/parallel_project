...
L'autovec misurato raggiunge 5.29 Gops/s = \textbf{97\% del tetto di bandwidth}. Il kernel è essenzialmente \textit{bandwidth-saturated}.
...
\subsubsection{Universal Hashing e Multiply-Shift}
...
\paragraph{Checksum FNV-1a.} Per la verifica di correttezza senza stampare $N$ valori:
\begin{lstlisting}
...
\begin{itemize}
    ...
    \item Autovec raggiunge 5.29 Gops/s = \textbf{97\% del tetto}
    \item AVX2 raggiunge 4.84 Gops/s = \textbf{88\% del tetto}
